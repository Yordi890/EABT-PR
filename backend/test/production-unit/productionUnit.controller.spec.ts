...
describe('ProductionUnitController', () => {
    ...
    beforeEach(async () => {
        ...
        productionUnitController = module.get<ProductionUnitController>(ProductionUnitController);
    ...
    describe('getAllProductionUnits', () => {
        it('should return an array of production unit', async () => {
            ...
            expect(await productionUnitController.getAllProductionUnits()).toEqual(result);
    ...
    describe('createProductionUnit', () => {
        it('should create a production unit', async () => {
            const productionUnit: ProductionUnitDto = {name: 'Ceferino Lopez', address: 'Calle 5ta #8'}

            await productionUnitController.createProductionUnit(productionUnit);
            expect(mockProductionService.addProductionUnit).toHaveBeenCalledWith(productionUnit);
        })
    })
    ...
    describe('updateProductionUnit', () => {
        it('should update a production unit', async () => {
            ...
            const newProductionUnit: ProductionUnitDto = {name: 'Ceferino Lopez', address: 'Calle 5ta #8'}

            await productionUnitController.updateProductionUnit(name, newProductionUnit);
            expect(mockProductionService.modifyProductionUnit).toHaveBeenCalledWith(name, newProductionUnit);
        })
    })
    ...
    describe('deleteProductionUnit', () => {
        it('should delete a production unit', async () => {
            ...
            expect(mockProductionService.deleteProductionUnit).toHaveBeenCalledWith(name);
        })
    })
