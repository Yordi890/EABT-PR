...
describe('ProductionUnitModule', () => {
    ...
    it('should contain the ProductionUnitController', () => {
        const productionUnitController = module.get<ProductionUnitController>(ProductionUnitController);
        expect(productionUnitController).toBeDefined();
    });

    it('should contain the ProductionUnitService', () => {
        expect(module.get<ProductionUnitService>(ProductionUnitService)).toBeDefined();
    });

    it('should contain the ProductionUnitRepository', () => {
        expect(module.get<ProductionUnitRepository>(ProductionUnitRepository)).toBeDefined();
    });
});
