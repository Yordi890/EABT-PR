...
describe('prismaHandler', () => {
    it('should throw ConflictException with the correct message for P2002 error code', () => {
        ...
        expect(() => prismaHandler(error)).toThrowError(new ConflictException("Already exist"));
    });
    ...
    it('should throw NotFoundException with the correct message for P2025 error code', () => {
        ...
        expect(() => prismaHandler(error)).toThrowError(new NotFoundException("Doesn't exist"));
    });
    ...
    it('should throw a generic error for other error codes', () => {
        ...
        expect(() => prismaHandler(error)).toThrowError(new Error("A database error occurred Some other error"));
    });
